...
export function closure2743_externref_shim(a: number, b: number, c: number): void;
export function closure2748_externref_shim(a: number, b: number, c: number, d: number): void;
export function closure2923_externref_shim(a: number, b: number, c: number): void;
