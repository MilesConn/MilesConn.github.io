...
export function closure1028_externref_shim(a: number, b: number, c: number): void;
...
export function closure2744_externref_shim(a: number, b: number, c: number): void;
export function closure2749_externref_shim(a: number, b: number, c: number, d: number): void;
export function closure2924_externref_shim(a: number, b: number, c: number): void;
