...
export interface InitOutput {
  ...
  readonly closure1210_externref_shim: (a: number, b: number, c: number) => void;
  ...
  readonly closure2926_externref_shim: (a: number, b: number, c: number) => void;
  readonly closure2931_externref_shim: (a: number, b: number, c: number, d: number) => void;
  readonly closure3106_externref_shim: (a: number, b: number, c: number) => void;
