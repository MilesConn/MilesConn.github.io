...
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0adc5ab7e727bebc(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hf25e5d0e4c55f49d(a: number, b: number): void;
export function closure1068_externref_shim(a: number, b: number, c: number): void;
...
export function closure2783_externref_shim(a: number, b: number, c: number): void;
export function closure2788_externref_shim(a: number, b: number, c: number, d: number): void;
export function closure2963_externref_shim(a: number, b: number, c: number): void;
