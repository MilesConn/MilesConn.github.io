...
export interface InitOutput {
  ...
  readonly closure2743_externref_shim: (a: number, b: number, c: number) => void;
  readonly closure2748_externref_shim: (a: number, b: number, c: number, d: number) => void;
  readonly closure2923_externref_shim: (a: number, b: number, c: number) => void;
