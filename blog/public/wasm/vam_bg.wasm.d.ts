...
export function closure1016_externref_shim(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc6fc87dd353b25ea(a: number, b: number): void;
export function closure2733_externref_shim(a: number, b: number, c: number): void;
export function closure2738_externref_shim(a: number, b: number, c: number, d: number): void;
export function closure2913_externref_shim(a: number, b: number, c: number): void;
