 ...
 */
export function wasm_run(): Promise<void>;
...
export interface InitOutput {
  ...
  readonly closure1031_externref_shim: (a: number, b: number, c: number) => void;
  ...
  readonly closure2747_externref_shim: (a: number, b: number, c: number) => void;
  readonly closure2752_externref_shim: (a: number, b: number, c: number, d: number) => void;
  readonly closure2927_externref_shim: (a: number, b: number, c: number) => void;
