...
export function closure1210_externref_shim(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h6d26f160a94f6021(a: number, b: number): void;
export function closure2926_externref_shim(a: number, b: number, c: number): void;
export function closure2931_externref_shim(a: number, b: number, c: number, d: number): void;
export function closure3106_externref_shim(a: number, b: number, c: number): void;
