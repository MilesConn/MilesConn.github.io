...
export function closure1031_externref_shim(a: number, b: number, c: number): void;
...
export function closure2747_externref_shim(a: number, b: number, c: number): void;
export function closure2752_externref_shim(a: number, b: number, c: number, d: number): void;
export function closure2927_externref_shim(a: number, b: number, c: number): void;
